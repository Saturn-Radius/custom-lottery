...
import { PresentWonIcon, TooltipText, useTooltip,} from '@pancakeswap/uikit'
...
const PreviousRoundTicketsInner: React.FC<{ roundId: string }> = ({ roundId }) => {
  ...
  return (
    <>
      ...
      <Flex borderTop={`1px solid ${theme.colors.borderColor}`} alignItems="center" justifyContent="center">
