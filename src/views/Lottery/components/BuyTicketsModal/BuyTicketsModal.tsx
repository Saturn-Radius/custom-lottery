...
const BuyTicketsModal: React.FC<BuyTicketsModalProps> = ({ onDismiss }) => {
  ...
  const getErrorMessage = () => {
    if (userNotEnoughCake) return t('Insufficient FAST balance')
  ...
  return (
    ...
    <StyledModal title={t('Buy Tickets')} onDismiss={onDismiss}>
      ...
      <BalanceInput
        ...
        currencyValue={
          cakePriceBusd.gt(0) &&
          `~${ticketsToBuy ? getFullDisplayBalance(priceTicketInCake.times(new BigNumber(ticketsToBuy))) : '0.00'} FAST`
        }
      />
      ...
      <Flex flexDirection="column">
        ...
        <Flex mb="8px" justifyContent="space-between">
          <Flex>
            ...
            <Text style={{display: 'inline'}} bold fontSize="14px" mr="4px">
