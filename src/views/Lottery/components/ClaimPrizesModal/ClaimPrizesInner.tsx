...
import { Flex, Button, Text, AutoRenewIcon } from '@fastswap-uikit'
import { PresentWonIcon } from '@pancakeswap/uikit'
      ...
      if (receipt.status) {
        toastSuccess(
          ...
          <ToastDescriptionWithTx txHash={receipt.transactionHash}>
            {t('Your FAST prizes for round %lotteryId% have been sent to your wallet', { lotteryId })}
