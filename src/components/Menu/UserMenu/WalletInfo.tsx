...
import { Box, Button, Flex, InjectedModalProps, LinkExternal, Skeleton, Text } from '@fastswap-uikit'
import { Message } from '@pancakeswap/uikit'
  ...
  return (
    <>
      ...
      <Flex alignItems="center" justifyContent="space-between" mb="24px">
        <Text color="textSubtle">{t('FAST Balance')}</Text>
